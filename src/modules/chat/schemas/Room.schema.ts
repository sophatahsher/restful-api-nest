...
const ConversationRoomSchema = SchemaFactory.createForClass(ConversationRoom).plugin(mongooseDelete, { overrideMethods: true });
export { ConversationRoomDocument, ConversationRoomSchema, ConversationRoomModel}