...
[Nest](https://github.com/nestjs/nest) framework **TypeScript** with Swagger Integration.
[Docker](https://www.docker.com) Deploy with docker 
...
- New `/src` dir,
- API Routes
- Basic Authentication through Nest Passport, GitHub, and Discord using **@nestjs/passport**
- TypeORM using **TypeORM**
- Mongo Database on **MongoDB**
- RabbitMQ using **RabbitMQ**
- Nest Websocket using WebsocketGateWay **@nestjs/websockets**
