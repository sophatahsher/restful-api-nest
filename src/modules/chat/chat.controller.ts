...
export class ChatController {
    ...
    @Post('/thread/request')
    async createChatThreadRequest(@Body() request: RequestThreadDto): Promise<HttpResponse> {
    ...
    async findChatThreadRequestById(@Param('id') id: FindRequestThreadDto): Promise<HttpResponse> {
        console.log('id: ', id);
    ...
    async deleteChatThreadRequest(@Param('id') id: DeleteRequestThreadDto): Promise<HttpResponse> {
        console.log('id: ', id);
    ...
    async acceptChatThreadRequest(@Param('id') id: DeleteRequestThreadDto): Promise<HttpResponse> {
        console.log('id: ', id);
        const result = await this.chatService.deleteChatThreadRequest(id);
        return {
            data: result
    ...
    @Post('/request')
    async createChatRequest(@Auth() auth: any, @Body() payload: RequestChatDto): Promise<HttpResponse> {
